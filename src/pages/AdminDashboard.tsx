...
import { 
  ...
  Settings2, TrendingUp, MessageSquareHeart 
} from 'lucide-react';
...
export const AdminDashboard: React.FC<{ onBack: () => void }> = ({ onBack }) => {
  ...
  return (
    <div className="flex h-screen bg-[#0A0A0A] text-white font-sans overflow-hidden">
      {/* Sidebar */}
      <div className="w-64 bg-[#050505] border-r border-white/5 flex flex-col h-full flex-shrink-0 relative z-20 shadow-[4px_0_24px_rgba(0,0,0,0.8)]">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div className="mb-8">
                ...
                <div className="h-px w-full bg-gradient-to-r from-aura-red/50 to-transparent mt-4 opacity-50" />
              </div>
